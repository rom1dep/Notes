...
// import type {} from "@ag-grid-community/ag-grid-community";
...
const GRID_VIEWS = [
    ...
    private $gridContainer: JQuery<HTMLElement>;
    ...
    constructor(args: ViewModeArgs) {
        ...
        this.$root = $(TPL);
        this.$gridContainer = this.$root.find(".table-view-container");
    ...
    async renderList(): Promise<JQuery<HTMLElement> | undefined> {
        ...
        //     eventBuilder = async () => await TableView.buildEvents(this.noteIds)
        // } else {
        ...
        // if (userInitialView && GRID_VIEWS.includes(userInitialView)) {
        //     initialView = userInitialView;
        // }

        // const calendar = new Calendar(this.$gridContainer[0], {
        //     plugins,
        //     initialView,
        //     events: eventBuilder,
        //     editable: isEditable,
        ...
        //     locale: await TableView.#getLocale(),
        //     height: "100%",
        //     nowIndicator: true,
        //     eventContent: (e) => {
        //         let html = "";
        ...
        //     headerToolbar: {
        //         start: "title",
        //         end: `${GRID_VIEWS.join(",")} today prev,next`
        //     }
        // });
        // calendar.render();
    ...
    //     const startDate = GridView.#formatDateToLocalISO(e.start);
    //     if (!startDate) {
    //         return { startDate: null, endDate: null };
    //     }
    //     let endDate;
    //     if (e.allDay) {
    //         endDate = GridView.#formatDateToLocalISO(GridView.#offsetDate(e.end, -1));
    //     } else {
    //         endDate = GridView.#formatDateToLocalISO(e.end);
    //     }
    ...
    //     let endTime = null;
    //     if (!e.allDay) {
    //         startTime = GridView.#formatTimeToLocalISO(e.start);
    //         endTime = GridView.#formatTimeToLocalISO(e.end);
    //     }
    //
    ...
    //         }
    //
    //         events.push(await GridView.buildEvent(dateNote, { startDate }));
    //
    ...
    //         const event = await GridView.buildEvent(childNote, { startDate });
    //         events.push(event);
    //     }
    //
    //     return events.flat();
    ...
    //         const startDate = GridView.#getCustomisableLabel(note, "startDate", "calendar:startDate");
    //
    //         if (note.hasChildren()) {
    ...
    //         }
    //
    //         const endDate = GridView.#getCustomisableLabel(note, "endDate", "calendar:endDate");
    //         const startTime = GridView.#getCustomisableLabel(note, "startTime", "calendar:startTime");
    //         const endTime = GridView.#getCustomisableLabel(note, "endTime", "calendar:endTime");
    //         events.push(await GridView.buildEvent(note, { startDate, endDate, startTime, endTime }));
    //     }
    //
    //     return events.flat();
    // }
    ...
    //     const titles = await GridView.#parseCustomTitle(customTitleAttributeName, note);
    ...
    //         if (!startTime) {
    //             const endDateOffset = GridView.#offsetDate(endDate ?? startDate, 1);
    //             if (endDateOffset) {
    //                 endDate = GridView.#formatDateToLocalISO(endDateOffset);
    //             }
    //         }
    //
    ...
    //                     const targetTitles = await GridView.#parseCustomTitle(targetCustomTitleValue, targetNote, false);
